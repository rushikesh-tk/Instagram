            ...
            <div className="flex justify-between">
              ...
              {item.postedBy._id === state._id && (
                <i
                  ...
                  className="material-icons pointer grow pa2 pv4"
                >
                  delete
                </i>
              )}
            ...
            <div className="card-conrent">
                ...
                <div>
                  {item.likes.includes(state._id) ? (
                    <i
                      ...
                      className="material-icons pointer grow pa2"
                    >
                      thumb_down
                    </i>
                  ) : (
              ...
              <div className="ph3 pb2">
                <form className="black-80">
                  <label for="comment" className="pv2 f6 b db mb2">
                    Add Comment...
                  </label>
                  <div style={{ display: "flex" }}>
                    ...
                    <div
                      ...
                      className="pointer f6 grow no-underline br2 ph3 pv2 mb2 dib bg-light-purple"
                    >
                      Add
                    </div>
                  </div>
